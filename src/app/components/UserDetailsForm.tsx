...
export default function UserDetailsForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate and save prompts for each selected subject
      const promptPromises = formData.subjects.map(async (subject) => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-[#2a2a2a] rounded-lg border border-[#3a3a3a] mb-8">
